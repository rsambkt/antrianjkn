    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form" action="#">
            <div class="form-group">
                ...
                <input type="hidden" id="idx" name="idx">
                    ...
                    foreach ($pegawai as $row) {
                        ?>
                        <option value="<?= $row->nrp ?>"><?= $row->pgwNama ?></option>
                        <?php
                    }
                    ?>
                    </select>
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="email">Ruang:</label>
                <div class="col-sm-10">
                    ...
                    foreach ($ruang as $row) {
                        ?>
                        <option value="<?= $row->idx ?>"><?= $row->ruang ?></option>
                        <?php
                    }
                    ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="checkbox" name="dokter" id="dokter" value="1">Dokter
                </div>
            </div>
