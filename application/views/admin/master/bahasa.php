            ...
            <div class="box box-success">
                ...
                <div class="box-body table-responsive">
                    <div class="row">
                        <div class="col-md-11">
                            <form action="#" method="GET" onsubmit="return false">
                                <div class="input-group">
                                    <input type="text" name="q" id="q" class="form-control pull-right" onkeydown="getbahasa(1)" placeholder="Search">
                        ...
                        <div class="col-md-1">
                            <div class="input-group">
                                <select class="form-control" name="limit" id="limit" onchange="getbahasa(1)">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form" action="#">
            <div class="form-group">
                <label class="control-label col-sm-2" for="email">Bahasa:</label>
                <div class="col-sm-10">
                <input type="hidden" id="idx" name="idx">
                <input type="text" class="form-control" id="bahasa" name="bahasa" placeholder="Masukkan bahasa">
                </div>
            </div>
        </form> 
      </div>
