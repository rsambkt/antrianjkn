            ...
            <div class="box box-success">
                ...
                <div class="box-body table-responsive">
                    <div class="row">
                        <div class="col-md-11">
                            <form action="#" method="GET" onsubmit="return false">
                                <div class="input-group">
                                    <input type="text" name="q" id="q" class="form-control pull-right" onkeydown="getprofesi(1)" placeholder="Search">
                        ...
                        <div class="col-md-1">
                            <div class="input-group">
                                <select class="form-control" name="limit" id="limit" onchange="getprofesi(1)">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form" action="#">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="profesi" name="profesi" placeholder="Masukkan profesi">
                </div>
            </div>
        </form> 
      </div>
