                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="tgl" id="tgl" class="form-control input-sm datepicker" value="<?= date('Y-m-d') ?>">
                                <span class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" id="btnRiwayatKunjungan" onclick="riwayatKunjungan()"><span class="fa fa-search" id="iconbtnRiwayatKunjungan"></span> Search</button>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <label for="noKartu">NO SEP</label>
                            <div class="input-group">
                            <input type="text" name="noSep" id="noSep" class="form-control input-sm" value="">
                                <span class="input-group-btn">
                                    <button class="btn btn-danger btn-sm" id="btnCekSep" onclick="cekSep()"><span class="fa fa-search" id="iconbtnCekSep"></span> Cari SEP</button>
                                </span>
                            </div>
                        </div>
                    </div>
