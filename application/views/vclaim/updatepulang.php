                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="tglMulai" id="tglMulai" value="<?= date('Y-m-d') ?>" class="form-control input-sm datepicker">
                        </div>
                        <div class="col-md-3">
                            <label for="noKartu">Sampai</label>
                            <input type="text" name="tglSelesai" id="tglSelesai" value="<?= date('Y-m-d') ?>" class="form-control input-sm datepicker">
                        </div>
