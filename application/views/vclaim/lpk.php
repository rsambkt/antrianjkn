                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                            <input type="text" name="TglMasuk" id="TglMasuk" class="form-control input-sm datepicker" value="<?= date('Y-m-d') ?>">
                                <span class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" onclick="riwayatLpk()">Search</button>
                                </span>
                            </div>
