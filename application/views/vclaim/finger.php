        ...
        <div class="box box-success">
                ...
                <div class="box-body">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#home">Cek Finger</a></li>
                        <li><a data-toggle="tab" href="#menu1" onclick="listFinger()">List Finger</a></li>
                    </ul>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="noKartu" id="c-noKartu" class="form-control input-sm">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary btn-sm" onclick="cekFinger()">Cek FInger</button>
                                        </span>
                                    </div>
                        ...
                        <div id="menu1" class="tab-pane fade">
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="noKartu">No Kartu</label>
                                    <div class="input-group">
                                    <input type="text" name="tglPelayanan" id="l-tglPelayanan" class="form-control input-sm datepicker" value="<?= date('Y-m-d')?>">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary btn-sm" onclick="listFinger()">Search</button>
                                        </span>
                                    </div>
                            ...
                            <div class="table-responsive no-padding">
                                <table class="table table-hover">
                                    ...
                                    <tbody id="getdata">
                                        <tr>
                                            <td colspan="2">Silahkan Enter No Kartu Dan Range Tanggal untuk mencari pasien</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
