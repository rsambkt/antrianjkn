        ...
        <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="noKartu">Status Klaim</label>
                        ...
                        <div class="col-md-3">
                            <label for="noKartu">Tanggal Pulang</label>
                            <div class="input-group">
                            <input type="text" name="tglpulang" id="tglpulang" class="form-control input-sm datepicker" value="<?= date('Y-m-d') ?>">
                                <span class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" onclick="riwayatKlaim()">Search</button>
                                </span>
                            </div>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan=2>Tgl Pulang SEP</th>
                            ...
                            <tbody id="gethata">
                                <tr>
                                    <th colspan="11">Silahkan Enter No Kartu Dan Range Tanggal untuk mencari pasien</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
