        ...
        <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="noKartu">Tgl Mulai</label>
                            <input type="text" name="tglMulai" id="tglMulai" class="form-control input-sm datepicker" value="<?= date('Y-m-d') ?>">
                        </div>
                        <div class="col-md-3">
                            <label for="noKartu">Tanggal Selesai</label>
                            <div class="input-group">
                            <input type="text" name="tglSelesai" id="tglSelesai" class="form-control input-sm datepicker" value="<?= date('Y-m-d') ?>">
                                <span class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" onclick="riwayatKlaimJasaraharja()">Search</button>
                                </span>
                            </div>
                    ...
                    <div class="table-responsive no-padding">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th colspan="8">Jasaraharja</th>
                                    <th colspan="10">SEP</th>
                                </tr>
                                <tr>
                                    <th>Tgl Kejadian</th>
                                    <th>No Register</th>
                            ...
                            <tbody id="getdata">
                                <tr>
                                    <th colspan="16">Silahkan Enter No Kartu Dan Range Tanggal untuk mencari pasien</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
