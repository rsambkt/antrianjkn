...
<section class="content container-fluid">
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1" data-toggle="tab"><span class="fa fa-picture-o"></span> List Permintaan Radiologi</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
                <div class="row">
                    <div class="col-md-9">
                        <form action="#" method="GET" onsubmit="return false">
                            <div class="input-group">
                                <input type="text" name="q" id="q" class="form-control pull-right" onkeyup="getPermintaanLabor(1)" placeholder="Search">
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            <select name="param" id="param" class="form-control" onchange="getPermintaanLabor(1)">
                    ...
                    <div class="col-md-1">
                        <div class="input-group">
                            <select class="form-control" name="limit" id="limit" onchange="getPermintaanLabor(1)">
