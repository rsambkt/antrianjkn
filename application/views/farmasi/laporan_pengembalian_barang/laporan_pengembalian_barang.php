                ...
                <div class="box-body">
                    <form id="form1" action="#" method="post" onsubmit="return false">
                        <div class="form-group">
                            <div class="col-md-4"><label for="">Periode Awal</label></div>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="col-md-4"><label for="">Periode Akhir</label></div>
                            <div class="col-md-8">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#cetak').click(function() {
            var a = $('#tglAwal').val();
            var b = $('#tglAkhir').val();
            openInNewTab("<?php echo base_url() . 'farmasi/laporan_pengembalian_barang/cetak_1?tAwal=' ?>" + a + "&tAkhir=" + b);
        });
