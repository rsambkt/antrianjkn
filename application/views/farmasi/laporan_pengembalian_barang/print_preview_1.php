...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">
                <h2>Laporan Pengembalian Barang<br />Periode : <?php echo $TGL_AWAL . " s/d " . $TGL_AKHIR ?></h2>
            </td>
        </tr>
    </table>
    ...
    <table class="bordered">
        <thead>
            ...
            <th width="80px">No Pengembalian</th>
            <th>Nama Rekanan</th>
...
<script>
    $(document).ready(function() {
        ...
        function getTable() {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/laporan_pengembalian_barang/get_data_1' ?>",
                type: "POST",
                data: {
                    tAwal: a,
                    tAkhir: b
