                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter keyword" style="width: 200px" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btnTambah').click(function() {
            var url = '<?php echo base_url() . 'farmasi/rekanan_khusus/tambah/' ?>';
        ...
        $('#keyword').keypress(function(ev) {
            ...
            if (keycode == '13') {
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi/rekanan_khusus/getView' ?>",
                    type: "POST",
                    data: {
                        sLike: $(this).val(),
    ...
    function edit(a) {
        var url = '<?php echo base_url() . 'farmasi/rekanan_khusus/tambah/' ?>' + a;
        window.location.href = url;
    }
    ...
    function hapus(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/rekanan_khusus/hapus' ?>",
                type: "POST",
                data: {
                    KDREKANAN: a,
                    <?= $this->security->get_csrf_token_name(); ?>: $('#csrf').val()
