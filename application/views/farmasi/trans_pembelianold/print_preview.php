    ...
    <table class="bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right"><?php echo number_format($x['HBELI'],2,',','.') ?></td>
                <td align="right"><?php echo number_format($x['JMLBELI'],0,',','.') ?></td>
                <td align="right"><?php echo number_format($total,2,',','.') ?></td>
                <td align="right"><?php echo number_format($x['HDISKON'],2,',','.') ?></td>
                <td align="right"><?php echo number_format($subTotal,2,',','.') ?></td>
            </tr>
            <?php endforeach; ?>
            <tr>
                <td colspan="7" align="right">Total Faktur</td>
                <td align="right"><?php echo number_format($totalFaktur,2,',','.') ?></td>
            </tr>
            <tr>
                <td colspan="7" align="right">Diskon Global</td>
                <td align="right"><?php echo number_format($DISKON_GLOBAL,2,',','.') ?></td>
            </tr>
            <tr>
                <td colspan="7" align="right">PPN (10%)</td>
                <td align="right"><?php echo number_format($TOTPPN,2,',','.') ?></td>
            </tr>
            <tr>
                <td colspan="7" align="right">Sub Total Faktur</td>
                <td align="right"><?php echo number_format($totalFaktur - $DISKON_GLOBAL + $TOTPPN,2,',','.') ?></td>
            </tr>
            <tr>
                <td colspan="7" align="right">Ongkos Kirim</td>
                <td align="right"><?php echo number_format($ONGKIR,2,',','.') ?></td>
            </tr>
            <tr>
                <td colspan="7" align="right">Grand Total</td>
                <td align="right"><?php echo number_format($totalFaktur - $DISKON_GLOBAL + $TOTPPN + $ONGKIR,2,',','.') ?></td>
            </tr>
