                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter Kategori Barang" style="width: 200px" />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Form Kategori Barang</h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#keyword').keypress(function(ev) {
            ...
            if (keycode == '13') {
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi/kategori_barang/getView' ?>",
                    type: "POST",
                    data: {
                        sLike: $(this).val(),
    ...
    function hapus(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/kategori_barang/hapus' ?>",
                type: "POST",
                data: {
                    KDKTBRG: a,
                    <?= $this->security->get_csrf_token_name(); ?>: $('#csrf').val()
    ...
    function simpan() {
        var a = $('#NMKTBRG').val();
        if (a == "") {
            alert('Ops. Kategori Barang harus di isi.');
        } else {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/kategori_barang/simpan' ?>",
                type: "POST",
