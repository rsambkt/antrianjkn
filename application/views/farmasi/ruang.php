...
<section class="content container-fluid">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Cari Depo / Apotik</h3>
            <div class="box-tools">
            ...
            <div class="row">
                ...
                foreach ($ruang as $r ) {
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <a href="#" onclick="pilihDepo(<?= $r->idx ?>)">
                            <div class="info-box">
                                <span class="info-box-icon <?= $style[$mod]?>"><i class="fa fa-home"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"><b>Apotek</b></span>
                                    <span class="info-box-number"><h4><?= $r->namadepo ?></h4></span>
                                </div>
                            </div>
                        </a>
