...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">Nota Retur Barang Masuk Bukan Pembelian</td>
        </tr>
    </table>
    <hr />  
    <table width="100%" border="0">
        <tr>
            ...
            <td width="300px"><?php echo $res['KDBMK_RET'] ?></td>
            <td width="150px">No Faktur di Retur</td>
            <td width="10px" align="center">:</td>
            <td><?php echo $res['KDBMK'] ?></td>
        </tr>
        <tr>
            <td>Tgl Retur</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($res['DTBMK_RET'])) ?></td>
            <td>Lokasi Obat</td>
            <td align="center">:</td>
            <td><?php echo getTransBMK($res['KDBMK'])['NMLOKASI'] ?></td>
        </tr>
    </table>
    ...
    <table class="bordered">
        ...
        <tbody>
            ...
            <?php if ($res['ALASAN'] !== ""): ?>
            <tr>
                <td colspan="6"><?php echo $res['ALASAN'] ?></td>
            </tr>
            <?php else: ?>
            <tr>
                <td colspan="6">-</td>
