...
<body class="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">
                <h2>Laporan Retur Peminjaman Obat</h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center"><?php echo $NMLOKASI ?></td>
        </tr>
    </table>
    <br />
    <br />
...
<script>
    $(document).ready(function() {
        ...
        function getTable() {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/laporan_retur_barang_pinjaman/get_data_lap' ?>",
                type: "POST",
                data: {
                    kLok: a,
                    tAwal: b,
                ...
                beforeSend: function() {
                    $('#getData').html("<tr><td colspan=6>Loading ... Please Wait</td></tr>");
                },
