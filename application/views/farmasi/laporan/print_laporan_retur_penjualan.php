...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">
                <h2>Laporan Return Penjualan<br />Periode : <?php echo $TGL_AWAL . " s/d " . $TGL_AKHIR ?></h2>
            </td>
        </tr>
    </table>
...
<script>
    $(document).ready(function() {
        ...
        function getTable() {
            ...
            var c = "<?php echo $_GET['kLok'] ?>";
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/laporan_penjualan/get_data_8' ?>",
                type: "POST",
                data: {
                    tAwal: a,
                    tAkhir: b,
