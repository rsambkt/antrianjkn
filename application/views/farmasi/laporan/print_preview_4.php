<html>
<head>
    <title>Laporan Resep Dokter</title>
</head>
<style>
    #A4{
...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center"><h2>Laporan Resep Dokter</h2></td>
        </tr>
    </table>
    <table width="100%" border="0">
        <tr>
            <td width="30px">Periode</td>
    ...
    <table class="bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right"><?php echo number_format($x['TotalR'],2,',','.') ?></td>
            </tr>
            <?php 
                $subTotal = $subTotal + ($x['TotalR']);
                endforeach; 
            ?>
            <tr>
