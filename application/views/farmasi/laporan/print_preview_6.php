...
<body class="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">
                <h2>Laporan Periode Detail Penjualan<br />Periode : <?php echo $TGL_AWAL . " s/d " . $TGL_AKHIR ?></h2>
            </td>
        </tr>
...
<script>
    $(document).ready(function() {
        ...
        function getTable() {
            ...
            var d = "<?php echo $LAYANAN ?>";
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/laporan_penjualan/get_data_6' ?>",
                type: "POST",
                data: {
                    kode: a,
                    tAwal: b,
