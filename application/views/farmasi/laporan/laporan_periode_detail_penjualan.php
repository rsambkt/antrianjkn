            ...
            <div class="box box-widget widget-report">
                ...
                <div class="box-body">
                    <form id="form1" action="#" method="post" class="form-horizontal" onsubmit="return false">
                        ...
                        <div class="form-group">
                            <label for="lokasi" class="label-control col-md-3">Jenis Pasien</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <label for="lokasi" class="label-control col-md-3">Periode Awal</label>
                            <div class="col-md-9"><input type="text" name="tglAwal" id="tglAwal" placeholder="__-__-____" class="form-control tanggal" /></div>
                        </div>
                        <div class="form-group">
                            <label for="lokasi" class="label-control col-md-3">Periode Akhir</label>
                            <div class="col-md-9"><input type="text" name="tglAkhir" id="tglAkhir" placeholder="__-__-____" class="form-control tanggal" /></div>
                        </div>
                        <div class="form-group">
                            <label for="lokasi" class="label-control col-md-3">&nbsp;</label>
                            <div class="col-md-9"><button type="button" id="cetak" class="btn"><i class="icon-print"></i> Cetak</button></div>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#cetak').click(function() {
            ...
            openInNewTab("<?php echo base_url() . 'farmasi/laporan_penjualan/cetak_6?kode=' ?>" + a + "&tAwal=" + b + "&tAkhir=" + c + "&layanan=" + d);
        });
