                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter nama supplier" style="width: 200px" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btnTambah').click(function() {
            var url = '<?php echo base_url() . 'farmasi/supplier/tambah/' ?>';
        ...
        $('#keyword').keypress(function(ev) {
            ...
            if (keycode == '13') {
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi/supplier/getView' ?>",
                    type: "POST",
                    data: {
                        sLike: $(this).val(),
        ...
        $('#btn_keyword').click(function() {
            $.ajax({
                ...
                beforeSend: function() {
                    $('tbody#getdata').html("<tr><td colspan=10></td></tr>");
                },
                success: function(data) {
                    $('tbody#getdata').html(data);
                },
    ...
    function edit(a) {
        var url = '<?php echo base_url() . 'farmasi/supplier/tambah/' ?>' + a;
        window.location.href = url;
    }
    ...
    function hapus(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/supplier/hapus' ?>",
                type: "POST",
                data: {
                    KDSUPPLIER: a,
                    <?= $this->security->get_csrf_token_name(); ?>: $('#csrf').val()
