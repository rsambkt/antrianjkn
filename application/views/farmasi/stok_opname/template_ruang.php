...
<section class="content container-fluid">
    <div class="alert alert-danger alert-dismissible">
        ...
        Lokasi obat yang tampil dibawah berdasarkan hak akses user. Silahkan Lapor Administrator jika lokasi user anda tidak tampil. 
    </div>
    <div class="row">
        <div class="col-xs-12">
...
function goLokasi(a){
    var url = '<?php echo base_url().'farmasi/stok_opname/goForm?kLok=' ?>' + a;
