...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="300px"><?php echo $KDJL ?></td>
            <td width="100px">Pasien</td>
            <td width="10px" align="center">:</td>
            <td><?php echo $NOMR.'-'.$NMPASIEN ?></td>
        </tr>
        <tr>
            <td>Tgl Inv</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($DTJL)) ?></td>
            <td>Reg.RS/Reg.Unit</td>
            <td align="center">:</td>
            <td><?php echo $ID_DAFTAR.'/'.$REG_UNIT ?></td>
        </tr>
        <tr>
            <td>Apotik</td>
            <td align="center">:</td>
    ...
    <table class="bordered">
        ...
        <tbody>
            <?php 
                ...
                $DISKON = $x['DISKON'];                
                $JMLJUAL = $x['JMLJUAL'];                
                $itemTotal = ($x['HJUAL']*$x['JMLJUAL'])-$x['DISKON'];                 
            ?>
            <tr>
                <td><?php echo $i++; ?></td>
                ...
                <td align="right">Rp. <?php echo number_format($x['HJUAL'],0,',','.') ?></td>
                <td align="right"><?php echo number_format($x['JMLJUAL'],0,',','.') ?></td>
                <td align="right">Rp. <?php echo number_format($x['DISKON'],0,',','.') ?></td>
                <td align="right">Rp. <?php echo number_format($itemTotal,0,',','.') ?></td>
            </tr>
            <?php 
            ...
            <tr>
                <td colspan="7" align="right">Total R</td>
                <td align="right">Rp. <?php echo number_format($subTotalR,0, ',', '.') ?></td>
            </tr>
            <tr>
                <td colspan="7" align="right">Grand Total</td>
                <td align="right">Rp. <?php echo number_format($subTotal+$subTotalR,0, ',', '.') ?></td>
            </tr>
            <tr>
            ...
            <?php if ($KETJL!==""): ?>
            <tr>
                <td colspan="8"><?php echo $KETJL ?></td>
            </tr>
            <?php else: ?>
            <tr>
                <td colspan="8">-</td>
