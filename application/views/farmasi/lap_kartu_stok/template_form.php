...
$(document).ready(function () { 
    ...
    $('select').select2({placeholder:"Pilih Lokasi Obat"});
    ...
    $('#btnKeyword').click(function(){
        a = $('#keywords').val();
        $.ajax({
            url         : "<?php echo base_url().'farmasi/lap_kartu_stok/getObat' ?>",
            type        : "POST",
            data        : {keywords:a},
            beforeSend  : function(){
...
function cetak(a){
    ...
    if (b==""){
        ...
        var url = '<?php echo base_url().'farmasi/lap_kartu_stok/cetak?kode=' ?>'+a+'&tAwal='+b+'&tAkhir='+c+'&kLok='+d;
        openInNewTab(url);
    }    
}
