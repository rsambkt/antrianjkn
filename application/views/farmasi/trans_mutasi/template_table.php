                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter Kode MT/Lokasi Tujuan" style="width: 200px"/>
...
$(document).ready(function () { 
    ...
    $('#btnKembali').click(function(){
        var url = '<?php echo base_url().'farmasi/trans_mutasi' ?>';
        window.location.href = url;        
    });

    $('#btnTambah').click(function(){
        //var a = "<?php echo $kLok ?>";
        var url = "<?php echo base_url().'farmasi/trans_mutasi/tambah' ?>";
        window.location.href = url;        
    });
    ...
    $('#keyword').keypress(function(ev){
        ...
        if (keycode == '13') {
            ...
            var b = "<?php echo $kLok ?>";
            $.ajax({
                url         : "<?php echo base_url().'farmasi/trans_mutasi/getView' ?>",
                type        : "POST",
                data        : {sLike:a,kLok:b},
                beforeSend  : function(){
...
function cetak(a){
    var url = '<?php echo base_url().'farmasi/trans_mutasi/cetak?kode=' ?>'+a;
    openInNewTab(url);        
}
