...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">
                <h2>Laporan Mutasi<br />Periode : <?php echo $TGL_AWAL . " s/d " . $TGL_AKHIR ?></h2>
            </td>
        </tr>
    </table>
...
<script>
    $(document).ready(function() {
        ...
        function getTable() {
            var a = "<?php echo $TGL_AWAL ?>";
            var b = "<?php echo $TGL_AKHIR ?>";
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/laporan_mutasi/get_data_1' ?>",
                type: "POST",
                data: {
                    tAwal: a,
                    tAkhir: b
