...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">
                DATA BARANG MASUK BUKAN PEMBELIAN
            </td>
        </tr>
    </table>
    <hr />
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="150px"><?php echo $KDBMK ?></td>

            <td width="100px">No Faktur</td>
            <td width="10px" align="center">:</td>
            <td width="150px"><?php echo $NOFAKTUR ?></td>
        ...
        <tr>
            <td>Tgl Rekap</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($DTBMK)) ?></td>
        ...
        <tr>
            <td>Rekanan</td>
            <td align="center">:</td>
            <td colspan="7"><?php echo $NMREKANAN ?></td>
        </tr>
    </table>
    ...
    <table class="bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right"><?php echo number_format($x['HMODAL'],2,',','.') ?></td>
                <td align="right"><?php echo number_format($x['JMLMASUK'],0,',','.') ?></td>
                <td align="right"><?php echo number_format($subTotal,2,',','.') ?></td>
            </tr>
            <?php endforeach; ?>
            <tr>
                <td colspan="5" align="right">Total Faktur</td>
            ...
            <?php if ($KETBMK!==""): ?>
            <tr>
                <td colspan="6"><?php echo $KETBMK ?></td>
            </tr>
            <?php else: ?>
            <tr>
                <td colspan="6">-</td>
