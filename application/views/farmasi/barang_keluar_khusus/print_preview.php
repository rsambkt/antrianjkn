...
<body id="A4">
    ...
    <table width="100%" border="0" id="directPrint1">
        <tr>
            <td align="center">
                ...
                <a href="#" onclick="printPOS()" class="btn">Print EPSON LX</a>
            </td>
        </tr>
    </table>
    <hr />
    <table width="100%" border="0">
        <tr>
            <td width="100px">No BKK</td>
            <td width="10px" align="center">:</td>
            <td width="350px"><?php echo $KDBKK ?></td>
        ...
        <tr>
            <td>Tgl BKK</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($DTBKK)) ?></td>
            <td>Lokasi Tujuan</td>
            <td align="center">:</td>
            <td><?php echo $NMREKANAN ?></td>
        </tr>
    </table>
    ...
    <table class="bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right"><?php echo number_format($x['JMLBKK'],0,',','.') ?></td>
            </tr>
            <?php 
                endforeach; 
            ?>
            ...
            <?php if ($KETBKK!==""): ?>
            <tr>
                <td colspan="5"><?php echo $KETBKK ?></td>
            </tr>
            <?php else: ?>
            <tr>
                <td colspan="5">-</td>
