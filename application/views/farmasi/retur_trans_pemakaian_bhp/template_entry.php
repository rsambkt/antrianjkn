                ...
                <div class="box-body">
                    ...
                    <form id="form1" role="form" onsubmit="return false">
                        <table class="table table-striped">
                            <tr>
                                <td class="w120">Kode Mutasi BHP</td>
                                <td class="w250">
                                    <div class="input-group input-group-sm">
                                        <input readonly type="text" name="KDMTBHP" id="KDMTBHP" class="form-control" />
                        ...
                        <thead>
                            <form id="form2" action="#" method="post" onsubmit="return false">
                                <tr>
                                    ...
                                    <th>
                                        <div class="input-group input-group-sm">
                                            <input readonly type="text" name="JMLMTBHP" id="JMLMTBHP" class="form-control inputmask rightAlign" data-inputmask="'alias': 'decimal', 'groupSeparator': ',', 'autoGroup': true, 'digits': 0, 'digitsOptional': false, 'placeholder': '0'" />
                                        </div>
                                    </th>
                                    <th>
                                        <div class="input-group input-group-sm">
                            ...
                            <form id="form1" method="get" class="form-horizontal" onsubmit="return false">
                                <div class="control-group">
                                    ...
                                    <div class="input-group col-md-12">
                                        <input type="text" id="xKDMTBHP" class="form-control" style="width: 350px;" />
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".inputmask").inputmask();
        $('select').select2({
            placeholder: 'Silahkan pilih option'
        });
        ...
        $('#kembali').click(function() {
            var a = "<?php echo $kLok ?>";
            window.location.href = "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp' ?>";
        });
        ...
        $('#xKDMTBHP').keyup(function(ev) {
            var event = ev.keyCode | ev.witch;
            if (event == 13) {
                var a = $('#xKDMTBHP').val();
                var b = "<?php echo $kLok ?>";
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/getMutasi' ?>",
                    type: "POST",
                    data: {
                        KDMTBHP: a,
                        LOKASI_ASAL: b
        ...
        $('#btnKeywordCariObat').click(function() {
            ...
            var c = "<?php echo $kLok ?>";
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/getObat' ?>",
                type: "POST",
                data: {
                    KDMTBHP: a,
                    keyword: b,
        ...
        $("#simpanTemp").click(function() {
            ...
            if (formItems['KDBRG'] == "") {
                ...
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/simpanTemp' ?>",
                    type: "POST",
                    data: formItems,
                    dataType: "JSON",
                    success: function(data) {
        ...
        $('#simpan').click(function() {
            ...
            if (formdata['KDMTBHP'] == "") {
                ...
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/simpan' ?>",
                    type: "POST",
                    data: formdata,
                    dataType: "JSON",
                    beforeSend: function() {
    ...
    function getTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/getTemp' ?>",
            beforeSend: function() {
    ...
    function emptyTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/emptyTemp' ?>",
            success: function(data) {
                getTemp();
            },
            error: function(xhr, ajaxOption, thrownError) {
    ...
    function setMutasi(a) {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/getArrMutasi' ?>",
            type: "POST",
            data: {
                KDMTBHP: a
            },
    ...
    function hapusTemp(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi/retur_trans_pemakaian_bhp/hapusTemp' ?>",
                type: "POST",
                data: {
                    IDX: a
                },
