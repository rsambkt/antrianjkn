                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter Kode Retur/Kode MTB" style="width: 200px"/>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="width:100px">Kode MT BHP</th>
                                <th>Tujuan Mutasi</th>
                                <th>Alasan Retur</th>
...
$(document).ready(function () { 
    ...
    $('#btnKembali').click(function(){
        var url = '<?php echo base_url().'farmasi/retur_trans_pemakaian_bhp' ?>';
        window.location.href = url;        
    });
    $('#btnTambah').click(function(){
        var a = "<?php echo $kLok ?>";
        var url = "<?php echo base_url().'farmasi/retur_trans_pemakaian_bhp/tambah' ?>";
        window.location.href = url;        
    });
    ...
    $('#keyword').keypress(function(ev){
        ...
        if (keycode == '13') {
            ...
            var b = "<?php echo $kLok ?>";
            $.ajax({
                url         : "<?php echo base_url().'farmasi/retur_trans_pemakaian_bhp/getView' ?>",
                type        : "POST",
                data        : {sLike:a,kLok:b},
                beforeSend  : function(){
...
function cetak(a){
    var url = '<?php echo base_url().'farmasi/retur_trans_pemakaian_bhp/cetak?kode=' ?>'+a;
    openInNewTab(url);        
}
