...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="350px"><?php echo $KDJL_RET ?></td>
        ...
        <tr>
            <td>Tgl Retur</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($DTJL_RET)) ?></td>
            <td>No MR</td>
            <td align="center">:</td>
            <td><?php echo $NOMR ?></td>
        </tr>
        <tr>
            ...
            <td align="center">:</td>
            <td><?php echo $REG_UNIT.' / '.$ID_DAFTAR ?></td>
            <td>Nama Pasien</td>
            <td align="center">:</td>
    ...
    <table class="bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right"><?php echo number_format($x['HJUAL'],0,',','.') ?></td>
            </tr>
            <?php 
                endforeach; 
            ?>
            <tr>
                <td colspan="6">Alasan</td>
            </tr>
            <?php if ($ALASAN_RET!==""): ?>
            <tr>
                <td colspan="6"><?php echo $ALASAN_RET ?></td>
            </tr>
            <?php else: ?>
            <tr>
                <td colspan="6">-</td>
