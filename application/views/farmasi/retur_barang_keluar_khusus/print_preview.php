...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">
                BUKTI RETUR PENGEMBALIAN BARANG
            </td>
        </tr>
    </table>
    <hr />
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="350px"><?php echo $KDBKK_RET ?></td>
            <td width="100px">Kode BKK</td>
            <td width="10px" align="center">:</td>
            <td><?php echo $KDBKK ?></td>
        </tr>
        <tr>
            <td>Tgl.Rekam</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($DTBKK_RET)) ?></td>
            <td>Lokasi Gudang</td>
            <td align="center">:</td>
        ...
        <tr>
            <td>Tgl.Retur</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y',strtotime($TGL_RETUR)) ?></td>
            <td>Rekanan</td>
            <td align="center">:</td>
