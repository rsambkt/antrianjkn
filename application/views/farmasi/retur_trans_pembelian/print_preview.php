...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center">Nota Retur Barang Masuk (Pembelian)</td>
        </tr>
    </table>
    <hr />  
    <table width="100%" border="0">
        <tr>
            ...
            <td width="300px"><?php echo $res['KDBL_RET'] ?></td>
            <td width="150px">No Faktur di Retur</td>
            <td width="10px" align="center">:</td>
            <td><?php echo $res['KDBL'] ?></td>
        </tr>
        <tr>
            <td>Tgl Retur</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($res['DTBL_RET'])) ?></td>
            <td>Lokasi Obat</td>
            <td align="center">:</td>
            <td><?php echo getTransBeli($res['KDBL'])['NMLOKASI'] ?></td>
        </tr>
    </table>
