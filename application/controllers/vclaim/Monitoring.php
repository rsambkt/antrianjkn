...
class Monitoring extends CI_Controller{
    ...
    function klaim(){
        ...
        $view=array(
            ...
            'content'=>$this->load->view('vclaim/monitoringklaim', $data, true),
            'index_menu'=>8,
            'lib'=>array(
                'javascript/sep.js'
            )
    ...
    function historipelayanan($nokartu="",$mulai="",$selesai=""){
        ...
        if(empty($selesai)) $selesai=$sekarang;
        // echo $mulai; exit;
        // Generate Header
        $header = "";
    ...
    function permintaankontrol($nokartu){
        ...
        $data= $this->db->get('suratkontrol')->result();
        header('Content-Type: application/json');
